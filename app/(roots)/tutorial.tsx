    ...
    <CustomBackground>
      <ScrollView
        contentContainerStyle={{
          flexGrow: 1,
          padding: 20,
          paddingTop: Platform.OS == "android" ? 70 : 10, // Add padding to the top to prevent overlap
        }}
      >
        ...
        <View className="mb-4">
          ...
          <Text className="text-base text-gray-700 mt-1">
            ...
            modal to have more information about what the options should look
            like. e.g if the question asks about forest or non-forest, the hint
            shows you what a forest should look like and what a non forest
            should look like
          </Text>
        </View>
